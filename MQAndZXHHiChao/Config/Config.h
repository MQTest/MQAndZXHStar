...
#define MQAlphaColor(r, g, b, a) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:a]
//保单显示文字颜色
...
#define The_MainColor MQColor(51, 153, 255)
#define MQGlobalBg MQColor(242, 242, 242)
